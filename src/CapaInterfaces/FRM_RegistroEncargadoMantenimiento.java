...
public class FRM_RegistroEncargadoMantenimiento extends javax.swing.JDialog {
    ...
    public void registrar_encargado_solicitud(){
        ...
        msj.msg_confirmacion(rootPane, "Registro de mantenimiento guardado con éxito.");
    ...
    public void actualizar_encargado_solicitud(){
        ...
        msj.msg_confirmacion(rootPane, "Registro actualizado con éxito.");
        actualizar_estado_solicitud();
    }
    ...
    private void btn_regresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_regresarActionPerformed
        if(msj.msg_Pregunta(this, "¿Está seguro que desea cancelar el envío de sus activos a mantenimiento?")==0){
            dispose();
        }
